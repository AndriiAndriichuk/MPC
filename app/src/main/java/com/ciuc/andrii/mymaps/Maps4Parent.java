...
public class Maps4Parent extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    private GoogleMap mMap;
    private FloatingActionButton btn_find_m;
    private FloatingActionButton btn_type;
    private FloatingActionButton btn_exit;
    private FloatingActionButton btn_children;
    Button btn_find;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.maps_4_parent_activity);
       ...
       // Toast.makeText(Maps4Parent.this,String.valueOf(emailValidator("andriuchuk77@gmail.com")),Toast.LENGTH_LONG).show();
        ...
        btn_children = findViewById(R.id.btn_children);
        ...
        btn_find.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!location.isEmpty()) {
                    Geocoder geocoder = new Geocoder(Maps4Parent.this);
                    try {
                    ...
                    InputMethodManager imm = (InputMethodManager) Maps4Parent.this.getSystemService(Activity.INPUT_METHOD_SERVICE);
        ...
        btn_exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("KEY_SAVE","-1");
                editor.apply();
                startActivity(new Intent(Maps4Parent.this, Autorization.class));
            }
        });
        ...
        btn_children.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Maps4Parent.this, MyChildren.class));
            }
        });
